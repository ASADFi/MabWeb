   ...
   <Image
    ...
    />
      ...
      <div className=" flex  justify-center  ">
        ...
        <div className=" w-80 h-96 bg-slate-950  rounded-xl  mt-9  ">
          ...
          <div className="  mx-7  ml-9  mt-2">
            ...
            <label className="font-mono  text-slate-500 text-lg">Password</label>
              ...
              <input className="placeholder:italic mt-1 placeholder:text-slate-400 block bg-slate-950 h-10 w-60 border border-slate-400 rounded-lg py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-purple-400 focus:ring-purple-400 focus:ring-1 sm:text-sm" id="password" type="password" placeholder="****************" />
